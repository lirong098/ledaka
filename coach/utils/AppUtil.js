...
var AppUtil = {
  ...
  loadCoachIndexAfterWxlogin: function (that, options, result, res, doit = null) {
    var _this = AppUtil;
    //缓存id
  ...
  postWxlogin: function (that, options, result, res, doit = null) {
    var _this = AppUtil;
    _this.request(that, _this.baseUrl + "index/Login/login", {
      ...
      options.coach_id = res.data.array.id;
      _this.loadCoachIndexAfterWxlogin(that, options, result, res, doit);
    }, true, null);
  },

  getUserInfo: function (that, options, result, doit = null) {
        ...
        wx.getUserInfo({
          success: function (data) {
            ...
            _this.request(that, _this.baseUrl + "index/Login/index?code=" + code, {
              ...
              _this.postWxlogin(that, options, result, res, doit);
            }, true, null);
          }
        })
      }
