...
Page({
  ...
  btnClick: function (e) {
    wx.navigateTo({
      url: '../addprogram/addprogram?program_id=' + program_id,
    })
  },
  ...
  navigateTo: function (e) {
    ...
    // console.log(tmp)
    if (tmp.length >= 2 && tmp[tmp.length - 2].route == "pages/mycoachinfo/mycoachinfo") {
      wx.navigateBack({
        delta: 1
      })
    } else {
      wx.navigateTo({
        url: "/pages/mycoachinfo/mycoachinfo?coach_id=" + coach_id
      })
    }
  },
  onShare: function () {
